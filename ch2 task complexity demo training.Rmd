...
test.passed = read_excel("/Users/carolynyang/Downloads/pilot_tc_clean.xlsx", sheet=3)
...
```{r}
latency.coverage = read_excel("/Users/carolynyang/Downloads/pilot_tc_clean.xlsx", sheet=2) #Call for the data set and sheet number 2 
...
```{r}
latency.coverage = read_excel("/Users/carolynyang/Downloads/pilot_tc_clean.xlsx", sheet=1) #Call for the data set and sheet number 2 
str(latency.coverage) #Check what each column is made off (numerical, character or factor)
